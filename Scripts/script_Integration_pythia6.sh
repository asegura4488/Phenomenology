...
sequ () {
	...
	cp ${DELPHESCARDFOLDER}/${DELPHESCARD} ${EVENTSFOLDER}/RunCards/${DELPHESCARD}
        cp ${PYTHIAPARAMFOLDER}/${PYTHIACARD}  ${EVENTSFOLDER}/RunCards/pythia_card_$i.dat
...
sequ2 () {
	...
	gzip -d $2/$3_$4/Events/run_01/unweighted_events.lhe.gz
        gzip -d $2/$3_$4/Events/run_01/tag_1_pythia_events.hep.gz 

	## Pythia 8 execution
##	${PYTHIA8FOLDER}/${PYTHIA8EXE} $2/RunCards/input_pythia_$4.cmnd $2/$3_$4/Events/run_01/output_pythia8.hep # &> /dev/null

	## Delphes execution
	${DELPHESFOLDER}/${DELPHESEXE} $2/RunCards/${DELPHESCARD} $2/$3_$4/Events/run_01/output_delphes.root $2/$3_$4/Events/run_01/tag_1_pythia_events.hep

	## ExRootAnalysis execution
	${EXROOTFOLDER}/${EXROOTEXE} $2/$3_$4/Events/run_01/tag_1_pythia_events.hep $2/$3_$4/Events/run_01/output_pythia6.root
